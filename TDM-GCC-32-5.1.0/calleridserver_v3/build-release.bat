...
if exist clridsrv.exe del clridsrv.exe
...
g++ -o clridsrv.exe main.o serialmodem.o -L%BOOST_LIB% -lboost_system-mgw51-mt-1_61 -lboost_thread-mgw51-mt-1_61 -lboost_regex-mgw51-mt-1_61.dll -lboost_locale-mgw51-mt-1_61.dll -lws2_32 -lwsock32
